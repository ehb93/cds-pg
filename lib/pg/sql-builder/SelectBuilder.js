...
class PGSelectBuilder extends SelectBuilder {
   ...
   */
  _columns(noQuoting) {
    console.log("NO QUOTING KIKE: " + noQuoting)
    if (this._obj.SELECT.columns) {
      ...
      /*console.log("lib:pg:sql-builder:SelectBuilder entramos a comprobar csn definition")
      console.log(this._csn);
      console.log(this._csn.definitions);
      console.log("fin")*/
      //kike
